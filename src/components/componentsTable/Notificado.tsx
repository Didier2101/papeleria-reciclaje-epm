                        ...
                        >
                            <div className="flex items-center justify-between">
                                <p className="text-titleGreen font-bold">
                                    ...
                                    <span className="font-normal"> ({registros[categoryTyped].notificado.length})</span> {/* Muestra la cantidad de registros notificados */}
                                </p>
                            ...
                            {openCategory === categoryTyped && (
                                <div>
                                    {/* Aquí enviamos los registros notificados de esa categoría a la tabla */}
                                    <Table
                                        data={registros[categoryTyped].notificado}
                                    />
                                </div>
                            )}
                        </li>
